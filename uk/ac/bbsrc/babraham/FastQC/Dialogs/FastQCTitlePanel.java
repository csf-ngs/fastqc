...
public class FastQCTitlePanel extends JPanel {
	...
	public FastQCTitlePanel () {
		...
		ImageIcon logo = new ImageIcon(ClassLoader.getSystemResource("uk/ac/bbsrc/babraham/FastQC/Resources/fastqc_icon_100.png"));
		...
		JTextField website = new JTextField(" www.bioinformatics.bbsrc.ac.uk/projects/ ");
